 ...
 *   GITHUB_REPO    (선택) 기본 'mapleland-coin-calculator'
...
const REPO = process.env.GITHUB_REPO || 'mapleland-coin-calculator';
const ALLOWED_ORIGIN = process.env.ALLOWED_ORIGIN || '*';

const TYPE_LABEL = { idea: '건의', bug: '오류', etc: '기타' };
const TITLE_MAX = 120;
const BODY_MAX = 5000;
